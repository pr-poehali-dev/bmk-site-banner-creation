...
export default function AboutPage() {
  const milestones = [
    { year: '1967', event: 'Основание Белебеевского молочного комбината' },
    { year: '1985', event: 'Модернизация производственных линий' },
    { year: '2005', event: 'Получение сертификата ISO 9001' },
